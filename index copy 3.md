...
<div class="botb-container">
  ...
  <div class="botb-stats-wrapper">
    <div class="botb-stats-grid">
      <div class="botb-stat-card">
        <div id="stat-repos" class="botb-stat-value">0</div>
        <div class="botb-stat-label">Top Repositories</div>
      </div>
      <div class="botb-stat-card">
        <div id="stat-papers" class="botb-stat-value">0</div>
        <div class="botb-stat-label">Research Papers</div>
      </div>
      <div class="botb-stat-card">
        <div id="stat-packages" class="botb-stat-value">0</div>
        <div class="botb-stat-label">AI Packages</div>
      </div>
      <div class="botb-stat-card">
        <div id="stat-stars" class="botb-stat-value">0</div>
        <div class="botb-stat-label">Total GitHub Stars</div>
      </div>
    </div>
  </div>
  ...
  <div class="botb-controls">
    <div class="botb-meta-text">
      <i class="fas fa-calendar-alt"></i> <span>Last Updated:</span> <span id="stat-updated">Checking...</span>
    </div>
...
async function loadDashboard() {
  ...
  try {
    ...
    // --- Update Stats (Using real data from JSON) ---
    const stats = data.stats || {};
    
    document.getElementById('stat-repos').textContent = fmtNum(stats.repo_count);
    document.getElementById('stat-papers').textContent = fmtNum(stats.paper_count);
    document.getElementById('stat-packages').textContent = fmtNum(stats.pkg_count);
    document.getElementById('stat-stars').textContent = fmtNum(stats.total_stars);
    
    document.getElementById('stat-updated').textContent = stats.last_updated || 'Just now';
